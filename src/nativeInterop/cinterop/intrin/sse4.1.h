...
const int SSE4_1_FROUND_TO_NEAREST_INT = 0x00;
const int SSE4_1_FROUND_TO_NEG_INF     = 0x01;
const int SSE4_1_FROUND_TO_POS_INF     = 0x02;
const int SSE4_1_FROUND_TO_ZERO        = 0x03;
const int SSE4_1_FROUND_CUR_DIRECTION  = 0x04;

const int SSE4_1_FROUND_RAISE_EXC = 0x00;
const int SSE4_1_FROUND_NO_EXC    = 0x08;

const int SSE4_1_FROUND_NINT      = (SSE4_1_FROUND_TO_NEAREST_INT | SSE4_1_FROUND_RAISE_EXC);
const int SSE4_1_FROUND_FLOOR     = (SSE4_1_FROUND_TO_NEG_INF | SSE4_1_FROUND_RAISE_EXC);
const int SSE4_1_FROUND_CEIL      = (SSE4_1_FROUND_TO_POS_INF | SSE4_1_FROUND_RAISE_EXC);
const int SSE4_1_FROUND_TRUNC     = (SSE4_1_FROUND_TO_ZERO | SSE4_1_FROUND_RAISE_EXC);
const int SSE4_1_FROUND_RINT      = (SSE4_1_FROUND_CUR_DIRECTION | SSE4_1_FROUND_RAISE_EXC);
const int SSE4_1_FROUND_NEARBYINT = (SSE4_1_FROUND_CUR_DIRECTION | SSE4_1_FROUND_NO_EXC);

__m128i sse4_1_blend_epi16(__m128i a, __m128i b, int8_t imm8);
__m128d sse4_1_blend_pd(__m128d a, __m128d b, int8_t imm8);
__m128 sse4_1_blend_ps(__m128 a, __m128 b, int8_t imm8);
...
__m128d sse4_1_dp_pd(__m128d a, __m128d b, int8_t imm8);
__m128 sse4_1_dp_ps(__m128 a, __m128 b, int8_t imm8);
int32_t sse4_1_extract_epi32(__m128i a, int8_t imm8);
int64_t sse4_1_extract_epi64(__m128i a, int8_t imm8);
int8_t sse4_1_extract_epi8(__m128i a, int8_t imm8);
float sse4_1_extract_ps(__m128 a, int8_t imm8);
...
__m128i sse4_1_insert_epi32(__m128i a, int32_t i, int8_t imm8);
__m128i sse4_1_insert_epi64(__m128i a, int64_t i, int8_t imm8);
__m128i sse4_1_insert_epi8(__m128i a, int8_t i, int8_t imm8);
__m128 sse4_1_insert_ps(__m128 a, __m128 b, int8_t imm8);
...
__m128i sse4_1_mpsadbw_epu8(__m128i a, __m128i b, int8_t imm8);
